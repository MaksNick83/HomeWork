package eu.hillel.hw16.taxidepot;

import eu.hillel.hw16.taxidepot.datamashines.Freight;
import eu.hillel.hw16.taxidepot.datamashines.Minivan;
import eu.hillel.hw16.taxidepot.datamashines.MotorTransport;
import eu.hillel.hw16.taxidepot.datamashines.Passenger;
import eu.hillel.hw16.taxidepot.services.TaxiDepot;
import eu.hillel.hw16.taxidepot.services.TaxiDepotImpl;
