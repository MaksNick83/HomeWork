...
import eu.hillel.hw20.entity.OrderNomenclature;
...
public class OrderServiceImpl implements OrderService {
    ...
    public Order createOfItemsCurrentDay(String number) {
        LocalDate localDate = LocalDate.now();
    ...
    public Boolean deleteAllOrdersSpecifiedQuantityAndSpecifiedProduct(String nameNomenclature, int quantity) {
